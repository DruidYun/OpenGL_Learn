...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		for (unsigned int i = 0; i < 4; i++)
		{
			...
			lightingShader.setVec3(str+pointLightIdx+"].position", pointLightPositions[i]);
			lightingShader.setVec3(str + pointLightIdx + "].ambient", 0.05f, 0.05f, 0.05f);
			lightingShader.setVec3(str + pointLightIdx + "].diffuse", 0.8f, 0.8f, 0.8f);
			lightingShader.setVec3(str + pointLightIdx + "].specular", 1.0f, 1.0f, 1.0f);
			lightingShader.setFloat(str + pointLightIdx + "].constant", 1.0f);
			lightingShader.setFloat(str + pointLightIdx + "].linear", 0.09f);
			lightingShader.setFloat(str + pointLightIdx + "].quadratic", 0.032f);
		} 
